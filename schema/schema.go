...
// contains the embedded .graphql files using golang's embed feature
//go:embed *.graphql models/*.graphql
var content embed.FS

// Source: https://github.com/tonyghita/graphql-go-example/blob/main/schema/schema.go
//
